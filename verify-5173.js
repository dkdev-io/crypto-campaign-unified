...
async function verify5173() {
  ...
  try {
    ...
    await page.goto('http://localhost:5173/campaigns/auth/setup', { waitUntil: 'domcontentloaded' });
    ...
    if (hasManualForm) {
      ...
      await page.click('button[style*="Save Committee Info & Continue"], button:has-text("Save Committee Info & Continue")');

...
async function testCommitteeForm() {
  ...
  try {
    ...
    const { data: verifyData, error: verifyError } = await supabase
      .from('campaigns')
      .select('id, title, committee_name, fec_committee_id, committee_address, committee_city, committee_state, committee_zip')
      .eq('id', campaign.id)
      .single();
    ...
    console.log(`   Address: ${verifyData.committee_address}, ${verifyData.committee_city}, ${verifyData.committee_state} ${verifyData.committee_zip}`);

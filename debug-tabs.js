...
async function debugTabs() {
  ...
  try {
    ...
    await page.screenshot({ path: '/Users/Danallovertheplace/crypto-campaign-unified/debug-initial.png' });
    ...
    for (let i = 0; i < buttons.length; i++) {
      ...
      if (text.trim() === 'Sign Up') {
        ...
        await page.screenshot({ path: '/Users/Danallovertheplace/crypto-campaign-unified/debug-after-click.png' });

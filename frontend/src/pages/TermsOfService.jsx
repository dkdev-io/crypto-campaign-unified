          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing or using our donation platform, you agree to be bound by these Terms of Service 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Our platform facilitates donations to political campaigns and causes. You must be at least 18 
                years old and legally eligible to make political contributions in your jurisdiction to use our 
                service.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Your use of our service is also governed by our Privacy Policy. We are committed to protecting 
                your personal information and handling it in accordance with applicable data protection laws.
              </p>
            </section>

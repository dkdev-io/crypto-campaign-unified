    ...
    try {
      ...
      if (error) {
        ...
        if (
          ...
          setErrors({
            submit: 'Email already registered. Please sign in or use a different email.',
          });
        } else if (error.message.includes('Password should be')) {
          setErrors({
            submit:
              'Password does not meet security requirements. Please use at least 8 characters.',
          });
        } else if (
            ...
            >
              ...
              <div className="bg-card border rounded-lg p-6 space-y-4">
                ...
                <div className="pt-4 border-t">
                  <p className="text-base text-muted-foreground mb-3">Didn't receive the email?</p>
        ...
        <div className="max-w-md w-full">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Start managing your campaign today</p>
            </div>

    ...
    <div className="space-y-6">
      ...
      {testResult && (
        <div className="crypto-card bg-primary/10">
          ...
          <pre className="text-sm overflow-auto bg-secondary p-4 rounded font-mono">
      ...
      <div className="crypto-card bg-accent/10 border-accent/20">
        ...
        <details className="cursor-pointer">
          ...
          <pre className="bg-card p-4 rounded text-sm overflow-auto mt-4 border border-border font-mono">
            {CREATE_TABLES_SQL}
          </pre>
        </details>
      </div>

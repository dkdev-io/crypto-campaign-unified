...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'hsl(var(--crypto-navy))' }}>
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-card border-r border-border shadow-lg transform transition-transform duration-300 ease-in-out ${
          sidebarOpen
          ...
          <div className="px-4 py-4 border-t border-border">
            <div className="flex items-center">
              ...
              <button
                ...
                className="ml-2 p-2 text-muted-foreground hover:text-foreground transition-colors duration-200"
                title="Sign out"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path

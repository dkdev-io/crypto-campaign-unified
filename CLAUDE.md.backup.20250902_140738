...
1. **STOP** → **ACKNOWLEDGE** → **EXPLAIN** → **DEMONSTRATE** → **RESTART**
2. **Escalation**: Warning → Termination → Agent replacement
...
|-------|---------|----------|
| 3000-3099 | Frontend (React, Next.js, Vue) | 1. Check port-registry.md |
| 3100-3199 | Backend APIs | 2. Use next available |
| 3200-3299 | Microservices | 3. Update registry |
| 5000-5099 | Alternative backends | 4. Commit changes |

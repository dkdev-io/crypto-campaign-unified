  ...
  try {
    ...
    if (!response.ok) {
      ...
      if (!dbResponse.ok) {
        ...
        console.log('📧 Email confirmations will be enabled when Supabase processes the config update')
        return
      }
    }
...
async function testEmailFlow() {
  try {
    ...
    console.log(`🔗 Check email for link to: https://cryptocampaign.netlify.app/auth?verified=true`)

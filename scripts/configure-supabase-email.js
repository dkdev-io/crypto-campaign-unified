...
function printManualConfigurationSteps() {
  ...
  log('1. Go to: https://supabase.com/dashboard/project/kmepcdsklnnxokoimvzo/auth/templates', 'info')
...
async function main() {
  ...
  log('- Auth Settings: https://supabase.com/dashboard/project/kmepcdsklnnxokoimvzo/auth/users', 'info')
}

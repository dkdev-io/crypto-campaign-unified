...
async function testDatabaseFunctions() {
  ...
  try {
    ...
    assert(
      ...
      'create_user_contribution_table function exists'
    );
  } catch (error) {
...
async function testTableNameGeneration() {
  ...
  const testCases = [
    { input: 'test@example.com', expected: 'offlinecontributions_test_example_com' },
    {
      ...
      expected: 'offlinecontributions_user_name_tag_domain_co_uk',
    },
...
async function testUserDataSourceTracking() {
  ...
  assert(
    sampleDataSource.table_name.startsWith('offlinecontributions_'),

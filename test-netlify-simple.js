...
(async () => {
  ...
  try {
    ...
    const hasSetupContent = pageContent.includes('Campaign Setup') || pageContent.includes('setup') || pageContent.includes('Tell us about');
    ...
    const hasAuthContent = authContent.includes('Sign In') || authContent.includes('Login') || authContent.includes('auth');

  ...
  describe('GET /api/campaign/:id', () => {
    ...
    it('should return campaign details successfully', async () => {
      mockSupabaseClient
        ...
        .select()
        .eq()
        .single.mockResolvedValue(TestHelpers.createMockSupabaseResponse(mockCampaign));

      const response = await request(app).get(`/api/campaign/${campaignId}`).expect(200);
    ...
    it('should return 400 for invalid UUID format', async () => {
      const response = await request(app).get('/api/campaign/invalid-uuid').expect(400);
    ...
    it('should return 404 for non-existent campaign', async () => {
      ...
      const response = await request(app).get(`/api/campaign/${campaignId}`).expect(404);
    ...
    it('should handle database errors', async () => {
      ...
      const response = await request(app).get(`/api/campaign/${campaignId}`).expect(500);
  ...
  describe('POST /api/campaign', () => {
    ...
    it('should create campaign successfully', async () => {
      ...
      mockSupabaseClient
        ...
        .insert()
        .select()
        .single.mockResolvedValue(TestHelpers.createMockSupabaseResponse(mockCreatedCampaign));

      const response = await request(app).post('/api/campaign').send(validCampaignData).expect(201);
    ...
    it('should handle database insertion errors', async () => {
      ...
      const response = await request(app).post('/api/campaign').send(validCampaignData).expect(500);
  ...
  describe('PUT /api/campaign/:id', () => {
    ...
    it('should update campaign successfully', async () => {
      ...
      mockSupabaseClient
        ...
        .eq()
        .select()
        .single.mockResolvedValue(TestHelpers.createMockSupabaseResponse(mockUpdatedCampaign));
  ...
  describe('GET /api/campaign/:id/stats', () => {
    ...
    it('should return campaign statistics successfully', async () => {
      mockSupabaseClient
        ...
        .select()
        .eq()
        .single.mockResolvedValueOnce(TestHelpers.createMockSupabaseResponse(mockCampaign));
      mockSupabaseClient
        .from()
        .select()
        .eq()
        .mockResolvedValueOnce(TestHelpers.createMockSupabaseResponse(mockContributions));

      const response = await request(app).get(`/api/campaign/${campaignId}/stats`).expect(200);
    ...
    it('should return 400 for invalid UUID format', async () => {
      const response = await request(app).get('/api/campaign/invalid-uuid/stats').expect(400);
    ...
    it('should return 404 for non-existent campaign', async () => {
      ...
      const response = await request(app).get(`/api/campaign/${campaignId}/stats`).expect(404);
    ...
    it('should handle empty contributions', async () => {
      ...
      mockSupabaseClient
        ...
        .select()
        .eq()
        .mockResolvedValueOnce(TestHelpers.createMockSupabaseResponse([]));
    ...
    it('should calculate last contribution timestamp correctly', async () => {
      ...
      expect(response.body.lastContribution).toBe(new Date('2024-01-02T00:00:00Z').getTime());
    });
  });

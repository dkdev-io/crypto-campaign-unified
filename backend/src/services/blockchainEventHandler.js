...
class BlockchainEventHandler {
    ...
    setupEventListeners() {
        ...
        this.contract.on('ContributionAccepted', async (
            contributor,
            amountWei,
            amountUsd,
            transactionHash,
        ...
        this.contract.on('ContributionRejected', async (
            contributor,
            amountWei,
            reason,
            transactionHash,
        ...
        this.contract.on('KYCStatusUpdated', async (
            contributor,
            isVerified,
            event
        ) => {
        ...
        try {
            ...
            const contributionData = {
                ...
                metadata: {
                    ...
                    logIndex: receipt.logs.findIndex(log => 
                        log.transactionHash === eventData.transactionHash
                    )
                }
            };

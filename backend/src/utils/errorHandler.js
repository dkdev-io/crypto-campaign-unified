...
const ERROR_CODES = {
  ...
  NETWORK_ERROR: {
    ...
    suggestions: ['Verify the website URL is correct', 'Check if the website is online', 'Try again in a few moments']
  },
  TIMEOUT: {
    message: 'The website took too long to respond. This might be a slow site.',
    suggestions: ['Try a different page from the same website', 'Wait a moment and try again', 'Check if the website is working in your browser']
  },
  ACCESS_DENIED: {
    message: 'The website blocked our analysis. Some sites restrict automated access.',
    suggestions: ['Try the main homepage URL instead of a specific page', 'Check if the site has a robots.txt that might block crawlers', 'Contact support if this is your own website']
  },
  NOT_FOUND: {
    message: 'The webpage was not found. Please check the URL.',
    suggestions: ['Verify the URL is spelled correctly', 'Try the main website homepage', 'Check if the page exists in your browser']
  },
  INVALID_URL: {
    message: 'The URL format is invalid. Please enter a valid website URL.',
    suggestions: ['Include http:// or https://', 'Use the full website address', 'Example: https://yoursite.com']
  },
  
  // Content and parsing errors
  NO_CONTENT: {
    message: 'The website appears to be empty or has no visible content to analyze.',
    suggestions: ['Try a different page with more content', 'Make sure the website has loaded completely', 'Check if the site requires JavaScript to load content']
  },
  PARSING_ERROR: {
    message: 'We had trouble analyzing the website content. The site may use unusual formatting.',
    suggestions: ['Try analyzing the main homepage', 'Check if the site loads properly in your browser', 'Some sites with heavy JavaScript may not work well']
  },
  NO_STYLES: {
    message: 'We couldn\'t find any useful colors or fonts to extract from this website.',
    suggestions: ['Try a page with more visual content', 'Make sure the site has loaded completely', 'Some minimal sites may not have extractable styles']
  },
  
  // Technical errors
  BROWSER_ERROR: {
    message: 'Our analysis tool encountered a technical issue. Please try again.',
    suggestions: ['Wait a moment and try again', 'Try a different URL from the same site', 'Contact support if this keeps happening']
  },
  MEMORY_ERROR: {
    message: 'The website is too complex to analyze right now. Please try a simpler page.',
    suggestions: ['Try the main homepage instead', 'Try a page with less content', 'Contact support for help with complex sites']
  },
  SECURITY_ERROR: {
    message: 'Security restrictions prevented us from analyzing this website.',
    suggestions: ['Make sure this is a public website', 'Try the main homepage URL', 'Some secure sites may not be analyzable']
  },
  
  // Service errors
  RATE_LIMITED: {
    message: 'Too many analysis requests. Please wait a moment before trying again.',
    suggestions: ['Wait 15 minutes before your next analysis', 'Consider analyzing fewer websites', 'Contact support for higher limits']
  },
  SERVICE_UNAVAILABLE: {
    message: 'Our analysis service is temporarily unavailable. Please try again later.',
    suggestions: ['Try again in a few minutes', 'Check our status page for updates', 'Contact support if the issue persists']
  },
  UNKNOWN: {
    message: 'An unexpected error occurred during analysis. Please try again.',
    suggestions: ['Try a different website URL', 'Wait a moment and retry', 'Contact support if this keeps happening']
  }
};
  ...
  for (let attempt = 0; attempt <= maxRetries; attempt++) {
    try {
      ...
      if (attempt < maxRetries) {
        console.log(`🔄 Retrying operation (attempt ${attempt + 2}/${maxRetries + 1}) in ${delay}ms`);

-- Fix campaigns table for setup wizard workflow
-- This will be executed directly via psql
...
-- Update existing campaigns so they don't break the workflow
UPDATE campaigns 
SET 
...
-- Verify the fix
SELECT 'Fixed campaigns table - columns added' as result;
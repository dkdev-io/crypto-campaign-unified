...
class CampaignContributionsApp {
  ...
  bindEventListeners() {
    ...
    document
      ...
      .addEventListener('submit', (e) => this.handleContribution(e));
    ...
    document
      .getElementById('contributionAmount')
      .addEventListener('input', (e) => this.updateAmountInfo(e));
  ...
  async loadWalletInfo() {
    try {
      ...
      if (response.ok) {
        ...
        document.getElementById('capacityProgress').textContent =
  ...
  validateForm() {
    ...
    if (allValid) {
      ...
      submitBtn.innerHTML =
        '<i class="fas fa-exclamation-triangle me-2"></i>Complete All Requirements';
    }
  }
  ...
  showInfo(message) {
    ...
    document.getElementById('errorMessage').textContent = message;
    document.querySelector('#errorToast .toast-header').className =

...
async function testDeployedContract() {
  ...
  try {
    ...
    console.log(
      `  Remaining Capacity: ${ethers.formatEther(contributorInfo.remainingCapacity)} ETH`
    );
    ...
    console.log(`  Address: ${contributor1.address}`);
    console.log(
      `  Cumulative Amount: ${ethers.formatEther(updatedContributorInfo.cumulativeAmount)} ETH`
    );
    console.log(
      `  Remaining Capacity: ${ethers.formatEther(updatedContributorInfo.remainingCapacity)} ETH`
    );

...
async function diagnoseLiveSite() {
  ...
  try {
    ...
    await page.goto('https://blue-token-campaigns.lovable.app', {
    ...
    try {
      ...
      if (hasForm) {
        ...
        const hasSubmitButton =
          (await page.$('button[type="submit"], input[type="submit"]')) !== null;
      ...
      try {
        ...
        if (status === 'Found') {
          ...
          await page.screenshot({
            path: `live-site${path.replace(/\//g, '-')}.png`,
            fullPage: true,
          });

...
const ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im93anZnZHptbWxyZHRwamR4Z2thIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjY4NTI4MTksImV4cCI6MjA0MjQyODgxOX0.dHyNtZfNzuaeBdrZiDzH4eMGYP4-FVWQd7F1Xf3VKz0';
  ...
  try {
    ...
    if (donorError) {
      ...
      if (donorError.message.includes('does not exist')) {
        ...
        return false;
      } else if (donorError.message.includes('duplicate key') || donorError.message.includes('already exists')) {
...
testDonorRegistration().then(() => {
  console.log('\n✅ Donor registration test completed');
  console.log('');
  console.log('📋 Next Steps:');
  console.log('1. If tables are missing, they need to be created in the owjvgdzmmlrdtpjdxgka project');

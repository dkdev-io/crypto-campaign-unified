...
async function verifyChanges() {
  ...
  try {
    ...
    console.log(`  Emojis Found: ${bankPageTest.hasEmojis ? '❌ YES (' + bankPageTest.emojiCount + ')' : '✅ NO'}`);
    console.log(`  Background: ${bankPageTest.backgroundColor}`);
    
    console.log('\nWebsite Style Page:');
    console.log(`  Heading: "${stylePageTest.headingText}"`);
    console.log(`  Emojis Found: ${stylePageTest.hasEmojis ? '❌ YES (' + stylePageTest.emojiCount + ')' : '✅ NO'}`);
